"use client"
import { AlignJustify, BookMarked, CircleFadingPlus, CircleUserRound, House } from 'lucide-react';
...
const navItems = [
  ...
  { icon: CircleUserRound, href: '/profile', label: "Profile" },
]
    ...
    <Sheet>
      ...
      <SheetContent className='w-[250px]'>
        ...
        <div className='mt-16 grid grid-rows-3 gap-10  grid-cols-1 text-2xl font-sans text-center'>
          {navItems.map(item => (
            <div key={item.label} className='flex gap-2 justify-center items-center text-center '>
